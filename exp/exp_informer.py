...
class Exp_Informer(Exp_Basic):
    ...
    def _get_data(self, flag):
        ...
        Data = data_dict[self.args.data]     # en focntion de nom pour choisir le type de fucntion
    ...
    def test(self, setting):
        ...
        np.save(folder_path+'metrics.npy', np.array([mae, mse, rmse, mape, mspe]))
        np.save(folder_path+'pred.npy', preds)                                      # saugarder les valeur prediction
        np.save(folder_path+'true.npy', trues)                                      #  saugarder les valeur reel
        return
    ...
    def predict(self, setting, load=False):
        ...
        np.save(folder_path+'real_prediction.npy', preds)                                     #  saugarder les valeur reel
