...
class Dataset_Custom(Dataset):
    def __init__(self, root_path, flag='train', size=None, 
                 features='S', data_path='my_data.csv', 
    ...
    def __read_data__(self):
        ...
        self.data_x = data[border1:border2]                  # longeur d'ensemble d'entrainemnt ,val, test 
        if self.inverse:
    ...
    def __getitem__(self, index):
        ...
        seq_x_mark = self.data_stamp[s_begin:s_end]              # 新提取的时间特征
...
class Dataset_Pred(Dataset):
    ...
    def __read_data__(self):
        ...
        border1 = len(df_raw)-self.seq_len             # 测试集开始
        border2 = len(df_raw)                          # 最后
        ...
        tmp_stamp = df_raw[['date']][border1:border2]    # border1:border2   --   debut de test:fin de test 
        tmp_stamp['date'] = pd.to_datetime(tmp_stamp.date)
        # pred_dates 的三个系数：date_range() -生成一个固定频率的日期范围
        #
        ...
        self.data_x = data[border1:border2]               # border1:border2   --   debut de test:fin de test 
        if self.inverse:
            self.data_y = df_data.values[border1:border2]
        else:
